...
::: image-ref
https://static.ksta.de/__images/2025/04/24/b3b17a0b-1da5-4e0f-9d6e-d321b248e1fa.jpeg?q=75&q=70&rect=0,259,4000,2250&w=2000&h=1334&fm=jpeg&s=cd6fd9eb8760f10aad114f59d21d74ce
:::
...
p_scatter <- ggplot(data = gapminder_2019, aes(x = demox_eiu, y = gini, color = world_6region)) +
  geom_point(size = 3) +
  theme_bg()
