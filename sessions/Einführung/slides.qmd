...
ggplot(data = gapminder_2023_bar, 
  ...
  labs(title = "Gini-Index in Europa und Zentralasien (Jahr: 2023)",
       x = "", y = "Gini-Index") +
  theme_bg()
...
ggplot(data = gapminder_2023, aes(x = world_6region, y = gini)) +
  geom_boxplot(aes(group = world_6region), staplewidth =.2) + 
  theme_bg() +
  labs(x = "", y = "", 
