...
Wir schauen uns jetzt Persönlichkeitseigenschaften von Charakteren aus [Friend](https://www.netflix.com/de/title/70153404) und [How I Met Your Mother](https://www.disneyplus.com/de-de/browse/entity-bc68ac79-3ace-4427-9ec0-5ee6f314d194) an.
...
Plotte die Ratings für die ausgewählten Charactere. Auf der x-Achse sollte die Frage `top_trait` zu sehen sein, auf der y-Achse das Rating. Styling machen wir später! Außerdem sollten der Name der Charactere (`char_name`) nache `color` und der Name der TV-Show (`uni_name`) nach `shape` unterscheidbar sein.
