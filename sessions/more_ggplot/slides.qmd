...
char_prepped3 <- char_prepped3 %>%
  mutate(
    image_x = ifelse(uni_name == "Friends", -1, 0.25),
    image_x_coord = ifelse(uni_name == "Friends", "humorless", "romantic")
  ) %>%
  arrange(top_trait)
...
::: {.callout-important}
Achtung, der Plot sieht noch etwas komisch aus, weil er nicht facettiert ist. 
:::
