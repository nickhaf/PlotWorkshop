...
gapminder_line <- gapminder %>%
  filter(country %in% c("deu", "che", "aut"), time >= 1850, time <= 2024) %>%
  drop_na(gini)


steuer <- gapminder_line %>%
  filter(time %in% c(1883, 1923, 1952, 1974, 1990, 1997, 2020), country == "deu") %>%
  arrange(time) %>%
...
## Ergänze um weitere Informationen, Vergleiche
