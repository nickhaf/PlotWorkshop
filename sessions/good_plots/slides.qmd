...
1. Stellt den anderen Gruppen eure Ergebnisse vor.
...
## {background-image="./images/garbage.jpg" background-size="1225px"}

::: {.absolute left="5%" top="5%" style="color:#269b88;backdrop-filter: blur(0px);"}
...
sf::st_layers(here::here("sessions", "good_plots", "data", "VG250_GEM.shp"))

# List available datasets
available_data <- gerda_data_list()

elect_dat <- load_gerda_web("federal_muni_raw", verbose = FALSE, file_format = "rds") %>% 
  filter(election_year == 2025)

ags_crosswalks <- load_gerda_web("ags_crosswalks", verbose = FALSE, file_format = "rds")
...
- Beachten: Oben hatte ich auch schon was zu size, bei den Kreisen. 
