...
## 
Excellence in statistical graphics consists of complex ideas communicated with clarity, precision, and efficiency. [@tufte1983vizual]
...
::: {.quote}
In general, in a time-series, use a baseline that shows the data not the zero point. [@tufte1983vizual]
:::
:::
:::
