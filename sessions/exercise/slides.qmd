...
- 🏋 Übung 2: Bubble Chart im Gapminder-Look   
...
```{r}
# install.packages(c("ggplot2", "ggimage", "here", "tidyverse", "ggtext", "glue", "patchwork", "ggrepel", "scales"))
...
## Optional: Abspeichern
saveRDS(gapminder, here::here("data", "gapminder_dat.rds"))
```
...
- im Rahmen der [Evaluation]{.highlight} unseres Workshops
